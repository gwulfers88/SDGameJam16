...
[CustomPropertyDrawer(typeof(Soriano.ConstantMotion.TransformElement))]
class ConstantMotionElementDrawer : PropertyDrawer
{
    ...
    static int GetExpansionLevel(SerializedProperty property)
    {
        ...
        if (mode.enumValueIndex == (int)Soriano.ConstantMotion.TransformMode.Arbitrary) return 2;
        // Expand one level.
        return 1;
    }
...
[CustomEditor(typeof(Soriano.ConstantMotion)), CanEditMultipleObjects]
